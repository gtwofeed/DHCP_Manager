...
namespace DHCP_Manager
{
    ...
    class Program
    {
        ...
        static ArrayList findDhcpClients(string server, string subnet)
        {
            ...
            // настройка контейнера для обработанных клиентов

            ArrayList foundClients = new ArrayList();

            // make call to unmanaged code
            // выполнить вызов неуправляемого кода
            ...
            // настройка клиентского массива, приведенного к DHCP_CLIENT_INFO_ARRAY
            // используя указатель из объекта ответа выше
